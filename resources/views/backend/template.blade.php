...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('backend/css/pages/dashboard-ecommerce.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('backend/css/plugins/charts/chart-apex.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('backend/css/plugins/extensions/ext-component-toastr.min.css')}}">
    <!-- END: Page CSS-->
    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">John Doe</span><span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="{{asset('backend/images/portrait/small/avatar-s-11.jpg')}}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span></a>
                        ...
                        <div class="card card-developer-meetup">
                            ...
                            <div class="card-body">
                                ...
                                <div class="avatar-group">
                                    ...
                                    >
                                        <img src="{{asset('backend/images/portrait/small/avatar-s-9.jpg')}}" alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div
                                        data-bs-toggle="tooltip"
                                        data-popup="tooltip-custom"
                                        ...
                                        class="avatar pull-up"
                                    >
                                        <img src="{{asset('backend/images/portrait/small/avatar-s-6.jpg')}}" alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div
                                        data-bs-toggle="tooltip"
                                        data-popup="tooltip-custom"
                                        ...
                                        class="avatar pull-up"
                                    >
                                        <img src="{{asset('backend/images/portrait/small/avatar-s-8.jpg')}}" alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div
                                        data-bs-toggle="tooltip"
                                        data-popup="tooltip-custom"
                                    ...
                                    >
                                        <img
                                            src="{{asset('backend/images/portrait/small/avatar-s-20.jpg')}}"
                                            alt="Avatar"
                                            width="33"
                                            height="33"
                                        />
                        ...
                        <div class="card card-browser-states">
                            ...
                            <div class="card-body">
                                ...
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img
                                            src="{{asset('backend/images/icons/mozila-firefox.png')}}"
                                            class="rounded me-1"
                                            height="30"
                                            alt="Mozila Firefox"
                                        />
                                ...
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img
                                            src="{{asset('backend/images/icons/apple-safari.png')}}"
                                            class="rounded me-1"
                                            height="30"
                                            alt="Apple Safari"
                                        />
...
<!-- BEGIN: Page JS-->
<script src="{{asset('backend/js/scripts/pages/dashboard-ecommerce.min.js')}}"></script>
<!-- END: Page JS-->
